...
export function Home() {
    ...
    return (
        <div className="h-screen bg-red-700 text-white p-4 flex flex-col items-center space-y-6">
            ...
            <div className="container max-w-5xl p-4 flex flex-1 flex-col items-center md:flex-row space-y-6 md:space-y-0 md:space-x-6">
                <div className="md:flex-1 flex justify-center">
                    <img src="/imgs/photo.png" className="max-w-md" />
                </div>

                <div className="md:flex1 flex flex-col space-y-6">
